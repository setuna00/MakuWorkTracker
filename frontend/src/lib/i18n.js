...
const zh = {
  ...
  'cover.cropperHint': '拖动图片调整位置，可以拖出留白 · 滚轮 / 双指 / 滑块缩放 · 点一下图片后可用方向键微调（按住 Shift 移动更快）',
  'cover.cropperHintTouch': '拖动调整位置，可拖出留白 · 双指或滑块缩放',
  'cover.applyCrop': '应用裁剪',
  'cover.cropFailed': '裁剪失败：{msg}',
  'cover.zoom': '缩放',
  'cover.zoomIn': '放大',
  'cover.zoomOut': '缩小',
  'cover.zoomHint': '100% = 刚好填满裁剪框 · 留白处输出为白底',
  'cover.position': '位置',
  'cover.fill': '填满',
  'cover.fit': '完整显示',
  'cover.centerH': '水平居中',
  ...
  'settings.other.showDropped': '显示弃坑作品',
  'settings.other.showDroppedDesc': '关闭后，弃坑作品不会出现在作品库、搜索和快速记录里，类型、标签和收藏夹的数字也不再算上它们；在作品库筛选里选"弃坑"时仍然可以看到。这个设置保存在服务器上，手机和电脑通用。',
  ...
  'settings.reports.intro': '每个月 1 号自动生成上月报告。点击下方任意月份可重新查看;事后补记了以前月份的记录,点"重新生成全部历史"会按当前数据重算所有月份。',
  'settings.reports.generateAll': '重新生成全部历史',
  'settings.reports.generatedMsg': '已按当前数据重算 {n} 份报告',
  ...
  'report.stats.activeDays': '活跃天数',
  'report.stats.activeWorks': '活跃作品',
  'report.stats.newWorks': '新开作品',
  'report.stats.completedWorks': '完成作品',
  'report.comparison': '较上月 {value}',
  'report.summary.lead': '本月活跃 {days} 天，记录 {entries} 次，涉及 {works} 部作品。',
  'report.summary.topWork': '记录最频繁的是《{title}》，本月活跃 {days} 天。',
  'report.activityOverview': '活跃概况',
  'report.longestStreak': '最长连续',
  'report.busiestDay': '最活跃日',
  'report.entriesShort': '{n} 条记录',
  'report.consumption': '本月观看 / 阅读量',
  'report.noConsumption': '暂无可统计的推进量',
  'report.workRanking': '本月作品排行',
  'report.workRankingBasis': '\u6392\u5e8f\u4f9d\u636e\uff1a\u6d3b\u8dc3\u5929\u6570\u4f18\u5148\uff0c\u5176\u6b21\u662f\u8bb0\u5f55\u6b21\u6570\u548c\u63a8\u8fdb\u91cf',
  'report.workRankingMore': '另有 {n} 部作品未显示',
  'report.activeDaysShort': '活跃 {n} 天',
  'report.unit.days': '天',
  'report.unit.anime': '集',
  'report.unit.tv': '集',
  'report.unit.movie': '部',
  'report.unit.manga': '章',
  'report.unit.novel': '章',
  'report.unit.other': '单元',
  'report.typeDistribution': '类型分布 · 按活跃作品',
  'report.topTags': '高频标签 · 按活跃作品',
  'report.noTags': '本月作品都没打标签',
  'report.ratingInsight': '本月活跃作品评分',
  'report.ratingBasis': '\u5e73\u5747\u5206\u53d6\u672c\u6708\u6709\u8bb0\u5f55\u4f5c\u54c1\u7684\u6700\u65b0\u5468\u76ee\u8bc4\u5206\uff0c\u672a\u8bc4\u5206\u4f5c\u54c1\u4e0d\u8ba1\u5165',
  'report.ratedCount': '已评分',
  'report.averageRating': '平均分',
  'report.highest': '最高分',
  'report.heatmap': '记录热力图',
  'report.heatmapLegend': '少 → 多',
  'report.heatmapDay': '{date}：{entries} 条记录，{works} 部作品，推进 {consumed}',
  'report.completed': '本月完成 ({n})',
  'report.milestones': '\u672c\u6708\u5b8c\u6210 {completed} \u00b7 \u8ffd\u5e73\u66f4\u65b0 {caughtUp}',
  'report.milestone.completed': '\u5b8c\u6210',
  'report.milestone.caughtUp': '\u8ffd\u5e73',
  'report.caughtUpProgress': '\u5df2\u8ffd\u81f3 {n}{unit}',
...
const en = {
  ...
  'newWork.step2.releaseYear': 'Year',
  ...
  'cover.cropperHint': 'Drag to reposition (blank space allowed) · scroll, pinch or use the slider to zoom · click the image, then nudge with arrow keys (hold Shift for bigger steps)',
  'cover.cropperHintTouch': 'Drag to reposition (blank space allowed) · pinch or slide to zoom',
  'cover.applyCrop': 'Apply',
  'cover.cropFailed': 'Crop failed: {msg}',
  'cover.zoom': 'Zoom',
  'cover.zoomIn': 'Zoom in',
  'cover.zoomOut': 'Zoom out',
  'cover.zoomHint': '100% = exactly fills the frame · blank areas are exported as white',
  'cover.position': 'Position',
  'cover.fill': 'Fill',
  'cover.fit': 'Fit',
  'cover.centerH': 'Center ↔',
  'cover.centerV': 'Center ↕',
  ...
  'settings.other.showDropped': 'Show dropped works',
  'settings.other.showDroppedDesc': 'When off, dropped works are hidden from the library, search and quick record, and left out of type, tag and favorites counts. They still show up when you filter the library by "Dropped". Saved on the server, so it applies to all your devices.',
  ...
  'settings.reports.intro': 'A new report is generated on the 1st of each month for the previous month. Click any month below to view; if you log entries for past months later, click "Regenerate all history" to recalculate every month from current data.',
  'settings.reports.generateAll': 'Regenerate all history',
  'settings.reports.generatedMsg': 'Recalculated {n} reports from current data',
  ...
  'report.stats.activeDays': 'Active days',
  'report.stats.activeWorks': 'Active works',
  'report.stats.newWorks': 'New works',
  'report.stats.completedWorks': 'Completed',
  'report.comparison': 'vs last month {value}',
  'report.summary.lead': 'Active on {days} days with {entries} entries across {works} works.',
  'report.summary.topWork': '“{title}” appeared most often, active on {days} days.',
  'report.activityOverview': 'Activity overview',
  'report.longestStreak': 'Longest streak',
  'report.busiestDay': 'Busiest day',
  'report.entriesShort': '{n} entries',
  'report.workRankingBasis': 'Ranked by active days, then entry count and progress volume',
  'report.consumption': 'Watched / read',
  'report.noConsumption': 'No measurable progress',
  'report.workRanking': 'Most active works',
  'report.workRankingMore': '{n} more works not shown',
  'report.activeDaysShort': '{n} active days',
  'report.unit.days': 'days',
  'report.unit.anime': 'episodes',
  'report.unit.tv': 'episodes',
  'report.unit.movie': 'films',
  'report.unit.manga': 'chapters',
  'report.unit.novel': 'chapters',
  'report.unit.other': 'units',
  'report.typeDistribution': 'By type · active works',
  'report.ratingBasis': 'Average of the latest-round ratings for works active this month; unrated works are excluded',
  'report.topTags': 'Top tags · active works',
  'report.noTags': 'No tags on this month\'s works',
  'report.ratingInsight': 'Ratings for active works',
  'report.ratedCount': 'Rated',
  'report.averageRating': 'Average',
  'report.highest': 'Highest',
  'report.heatmap': 'Daily activity',
  'report.milestones': 'Completed {completed} \u00b7 caught up {caughtUp}',
  'report.milestone.completed': 'Completed',
  'report.milestone.caughtUp': 'Caught up',
  'report.caughtUpProgress': 'Caught up to {n} {unit}',
  'report.heatmapLegend': 'less → more',
  'report.heatmapDay': '{date}: {entries} entries, {works} works, {consumed} consumed',
  'report.completed': 'Completed ({n})',
  'report.completedAndMore': '+{n} more',
  'report.round': 'Round {n}',
  'report.mon': 'M',
  'report.tue': 'T',
  'report.wed': 'W',
  'report.thu': 'T',
