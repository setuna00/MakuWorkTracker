...
from .routers import works, watchings, progress, tags, tag_groups, collections, timeline, admin, meta, reports, preferences
...
app = FastAPI(title="Maku - Works Tracker", version=settings.app_version, lifespan=lifespan)
